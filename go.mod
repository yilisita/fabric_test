...
require (
	...
	github.com/hyperledger/fabric-samples/asset-transfer-basic/chaincode-go v0.0.0-20211007180822-576b2e74c963 // indirect
	...
	github.com/yilisita/goNum v0.0.0-20211016062908-389802900fd8 // indirect
